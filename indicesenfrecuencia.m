function [pxx,f1, uf,vlf,lf,hf,ptotal,hfnorm,lfnorm,lfhf]=indicesenfrecuencia(s,fs1)
tiempo=cumsum(s);
s1=detrend(s);
fs3=2;
...
[pxx,f1]=pwelch(RRn1,[],[],[],2);
% nfft=2^nextpow2(lenght(pxx));
% freq=fs3/2*linspace(0,1,nfft/2+1);

%[ f1,pxx ] = remst(s, fpwelchs1);
